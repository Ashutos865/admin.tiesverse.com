...
const S = {
  page: { minHeight: '100vh', background: '#0A0A0B', display: 'grid', placeItems: 'center', padding: 16 },
  shell: { width: '100%', maxWidth: 440, animation: 'none' },
  hero: {
    position: 'relative', overflow: 'hidden', borderRadius: 28, padding: 26,
    minHeight: '38vh', display: 'flex', flexDirection: 'column', justifyContent: 'flex-end',
  ...
  otpRow: { display: 'flex', gap: 10, marginBottom: 14 },
  otpCell: { flex: 1, minWidth: 0, height: 62, textAlign: 'center', fontSize: 22, fontWeight: 700, color: '#fff', background: '#1C1C20', border: '1px solid rgba(255,255,255,.08)', borderRadius: 16, outline: 'none', caretColor: '#FE7A00' },
