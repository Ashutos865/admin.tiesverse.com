...
_ENABLED_SEED = {
    ...
    'webinar_updated': 'WEBINAR_EMAIL_ENABLED',
...
EMAIL_TEMPLATES = {
    ...
    'webinar_updated': {
        'name': 'Webinar - Schedule changed',
        'description': 'Sent automatically to registrants when a session’s date or time is edited.',
        'subject': 'Updated timing for {{topic}}',
        'from_name': 'Tiesverse',
        'from_email': '',
        'allow_attachment': False,
        'variables': ['name', 'topic', 'date', 'time', 'join_link'],
        'content': {
            'heading': 'The timing has changed',
            'body': 'Hi {{name}},\n\nThe schedule for {{topic}} has been updated. Please note the new date and time below - your existing joining link still works.',
            'table': [
                {'label': 'Session', 'value': '{{topic}}'},
                {'label': 'New date', 'value': '{{date}}'},
                {'label': 'New time', 'value': '{{time}}'},
            ],
            'closing': 'Sorry for the change, and thank you for adjusting. See you there.',
            'button': {'label': 'Join at the new time', 'url': '{{join_link}}'},
            'signature': '- The Tiesverse Team',
        },
    },
    'webinar_followup': {
